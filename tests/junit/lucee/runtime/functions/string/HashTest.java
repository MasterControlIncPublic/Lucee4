...
class HashTest {
    ...
    void shouldHashUUIDWithDefaultAlgorithmAndIterations() throws Exception {
        ...
        String result = Hash.invoke("41cb5016-239d-4abd-979f-8f212a8f8a89", null, 1);
    ...
    void shouldHashUUIDWithDefaultIterations() throws Exception {
        Security.addProvider(new BouncyCastleFipsProvider());
        String result = Hash.invoke("41cb5016-239d-4abd-979f-8f212a8f8a89", FipsAlgorithm.SHA256, 1);
        assertEquals("18F7459130E82CDB8A2247868820AF885851279EBCCBCFC2E88FD3B7C72F3EC3", result);
    }
    ...
    void shouldHashUUID() throws Exception {
        Security.addProvider(new BouncyCastleFipsProvider());
        String result = Hash.invoke("41cb5016-239d-4abd-979f-8f212a8f8a89", FipsAlgorithm.SHA256, 1000000);
