...
public interface Resource extends Serializable {
     ...
     * abstract pathname.
     *
     * @return  <code>true</code> if and only if the resource system actually
     *          contains a resource denoted by this abstract pathname <em>and</em>
    ...
    /**
     * Deletes the resource denoted by this abstract pathname.  If
     * this pathname denotes a directory, then the directory must be empty, 
     * when argument "force" is set to false, when argument "force" is set to true,
     * also the children of the directory will be deleted.
     * @param force 
     *
     * @throws  IOException
     ...
     * exists.
     *
     * @return  <code>true</code> if and only if the resource denoted
     ...
     * unique canonical form.  Every pathname that denotes a nonexistent resource 
     * also has a unique canonical form.  The canonical form of
     * the pathname of a nonexistent file or directory may be different from
     * the canonical form of the same pathname after the resource is
     * created.  Similarly, the canonical form of the pathname of an existing
     * resource may be different from the canonical form of the same
     * pathname after the resource is deleted.
     *
     ...
     * string is returned.
     *
     * @return  The name of the resource denoted by this abstract
     ...
     *
     * @return  The length, in bytes, of the resource denoted by this abstract
     *          pathname, or <code>0L</code> if the resource does not exist
     *
     */
     ...
     * ResourceNameFilter#accept}</code> method of the filter is invoked on this
     ...
     * same as that of the <code>{@link #listResources()}</code> method, except
     ...
     * <code>{@link ResourceFilter#accept(Resource)}</code> method of
     ...
     * pathnames are accepted.  Otherwise, a pathname satisfies the filter
     * if and only if the value <code>true</code> results when the
     * <code>{@link ResourceNameFilter#accept}</code> method of the filter is
     ...
     * @param value 
     * @throws IOException throwed when no access to change the value, 
