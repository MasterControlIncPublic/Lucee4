...
public final class ConfigWebUtil {
    ...
    public static String replacePlaceholder(String str, Config config) {
    	...
    	if(StringUtil.startsWith(str,'{')){
            ...
            // Config Server
            if(str.startsWith("{lucee-config") || str.startsWith("{railo-config")) {
            ...
            else if(config!=null && (str.startsWith("{lucee-server") || str.startsWith("{railo-server"))) {
            ...
            // Config Web
            else if(str.startsWith("{lucee-web") || str.startsWith("{railo-web")) {
