...
public abstract class ConfigImpl implements Config {
	...
	private ExtensionProvider[] extensionProviders=LUCEE_EXTENSION_PROVIDERS;
	...
	private ImportDefintion componentDefaultImport=new ImportDefintionImpl("org.lucee.cfml","*");
    ...
    private static FunctionLib[] loadFLDs() {
		...
		} catch (FunctionLibException e) {e.printStackTrace();
	...
	private static TagLib[] loadTLDs() {
		...
		} catch (TagLibException e) {e.printStackTrace();
			return new TagLib[]{};
		}
	}
    ...
    public void createTag(TagLib tl,String filename) {// Jira 1298
        ...
        tlt.setName(name);
        tlt.setTagClass("lucee.runtime.tag.CFTagCore");
    ...
    public void createFunction(FunctionLib fl,String filename) {
    	...
    	flf.setCls("lucee.runtime.functions.system.CFFunction");
    	flf.setName(name);
