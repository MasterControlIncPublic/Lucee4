...
public final class XMLConverter extends ConverterSupport {
	...
	private String _serializeDateTime(DateTime dateTime) {
		/* ACF FORMAT
		String strDate = new lucee.runtime.format.DateFormat(Locale.US).format(dateTime,"mmmm, dd yyyy");
		String strTime = new lucee.runtime.format.TimeFormat(Locale.US).format(dateTime,"HH:mm:ss");
	...
	private Object _deserializeQuery(Element recordset) throws ConverterException {
		try {
			...
			Query query=new QueryImpl(
					lucee.runtime.type.util.ListUtil.listToArray(
