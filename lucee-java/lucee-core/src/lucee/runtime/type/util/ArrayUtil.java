...
public final class ArrayUtil {
	...
	*/
	...
	public static Byte[] toReferenceType(byte[] primArr) {
		...
		for(int i=0;i<primArr.length;i++)refArr[i]=Byte.valueOf(primArr[i]);
		return refArr;
	}
	...
	public static Character[] toReferenceType(char[] primArr) {
		...
		for(int i=0;i<primArr.length;i++)refArr[i]=Character.valueOf(primArr[i]);
		return refArr;
	}
	...
	public static Float[] toReferenceType(float[] primArr) {
		...
		for(int i=0;i<primArr.length;i++)refArr[i]=Float.valueOf(primArr[i]);
		return refArr;
	}
	...
	public static Double[] toReferenceType(double[] primArr) {
		...
		for(int i=0;i<primArr.length;i++)refArr[i]=Double.valueOf(primArr[i]);
		return refArr;
	}
