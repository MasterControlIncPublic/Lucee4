...
public class SimpleQuery implements Query, ResultSet, Objects {
	...
	public boolean addColumn(String columnName, lucee.runtime.type.Array content)
	...
	public boolean addColumn(Key columnName, lucee.runtime.type.Array content)
			throws PageException {
		throw notSupported();
	}
	...
	public synchronized boolean addColumn(String columnName,
			lucee.runtime.type.Array content, int type)
			throws DatabaseException {
		throw notSupported();
	}
