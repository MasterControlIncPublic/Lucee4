...
public final class HtmlEmailImpl extends MultiPartEmail
{
     ...
     *  also see jakarta.mail.internet.MimeBodyPart for definitions
     *
     */
    ...
    private void buildAttachments() throws MessagingException, EmailException
    {
        ...
        if (!StringUtil.isEmpty(this.text)) {
            ...
            if (!StringUtil.isEmpty(this.getCharsetName())) {
                msgText.setContent(
                    this.text,
                    EmailConstants.TEXT_PLAIN + "; charset=" + this.getCharsetName());
            }
            else {
        ...
        if (!StringUtil.isEmpty(this.html))
        {
            ...
            if (!StringUtil.isEmpty(this.getCharsetName()))
            {
                msgHtml.setContent(
                    this.html,
                    EmailConstants.TEXT_HTML + "; charset=" + this.getCharsetName());
            }
            else
            {
