...
/**
* Provides a programmatic interface to the Lucee scheduling engine. You can run a specified 
...
public final class Schedule extends TagImpl {
	...
	**/
	public void setAction(String action) throws ApplicationException	{
	    ...
	    else throw new ApplicationException("attribute action with value ["+action+"] of tag schedule is invalid","valid attributes are [delete,run,update,list,resume,pause]");
	}
	...
	**/
	public void setOperation(String operation) throws ApplicationException	{
		...
		if(!operation.equals("httprequest"))
	...
	**/
	...
	public int doStartTag() throws PageException	{
	    ...
	    switch(action) {
    		...
    		case ACTION_UPDATE: doUpdate();	break;
    		case ACTION_LIST: doList();	break;
    		case ACTION_PAUSE: doPause(true);	break;
    		case ACTION_RESUME: doPause(false);	break;
	    }
		return SKIP_BODY;
	}
